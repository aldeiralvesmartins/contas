...
@section('content')
    <div class="max-w-2xl mx-auto">
        <div class="mb-8">
            ...
            <p class="text-slate-600 mt-2">Crie uma nova categoria para organizar suas transações</p>
        </div>

        <div class="card p-8">
            <form action="{{ route('categories.store') }}" method="POST" class="space-y-6" data-validate>
                @csrf
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const initialCheckedColor = document.querySelector('.color-radio:checked');
            if (initialCheckedColor) {
                initialCheckedColor.dispatchEvent(new Event('change'));
            }
