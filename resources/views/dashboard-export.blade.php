...
<head>
    ...
    <title>Relatório - Dashboard {{ $selected_month_name }}</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <div>
                <div class="title">Relatório - Dashboard</div>
        ...
        <div class="cards">
            <div class="card">
                ...
                <div class="value income">R$ {{ number_format($income, 2, ',', '.') }}</div>
            </div>
            <div class="card">
                <div class="label">Saídas</div>
                <div class="value expense">R$ {{ number_format($expense, 2, ',', '.') }}</div>
            </div>
            <div class="card">
        ...
        <h3 style="margin: 16px 0;">Transações do período</h3>
        <table>
            <thead>
                <tr>
                    <th>Data</th>
